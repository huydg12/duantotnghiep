...
(
  ...
  [DISTRICT_NAME] NVARCHAR(150), -- ➕ thêm tên quận/huyện
...
VALUES
	(N'admin', N'123456', N'admin@example.com', N'0909123456', GETDATE(), 1, 1),
	(N'customer', N'abcdef', N'khachhang01@example.com', N'0911123456', GETDATE(), 1, 2),
	(N'staff', N'qwerty', N'nhanvien01@example.com', N'0922123456', GETDATE(), 1, 3);
GO
...
INSERT INTO dbo.ADDRESS
	(FULL_ADDRESS, NUMBER_PHONE, FULL_NAME, CUSTOMER_ID, IS_DEFAULT, WARD_NAME, DISTRICT_NAME, CITY_NAME)
VALUES
	(N'123, Đường 365, P.1,Lê Chân, TP.Hải Phòng', N'0911123456', N'Bé 1', 1, 1, N'Phường 1', N'Lê Chân', N'TP Hải Phòng');
GO
