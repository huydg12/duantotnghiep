      ...
      <div class="col-lg-6">
        <div class="contact-form-wrapper">
          ...
          <p class="mb-4 text-muted">
            Vui lòng điền thông tin bên dưới, chúng tôi sẽ liên lạc với bạn trong thời gian sớm nhất.
          </p>
          ...
          <form class="needs-validation" novalidate>
            ...
            <button type="submit" class="btn btn-primary px-4 py-2">Gửi liên hệ ngay</button>
          </form>
        </div>
      </div>
    </div>
